...
namespace ZiiqueSocialBackend.Migrations
{
    ...
    [Migration("20250108120606_Added_ProfileAuth_binding")]
    partial class Added_ProfileAuth_binding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ProfileAuth", b =>
                {
                    b.Property<Guid>("ProfileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Profile", b =>
                {
                    b.HasOne("Domain.ProfileAuth", null)
                        .WithOne()
                        .HasForeignKey("Domain.Profile", "Guid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
